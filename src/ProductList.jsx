...
import logoSrc from './assets/eco-logo.webp';
...
const handlePlantsClick = (e) => {
   ...
   const handleContinueShopping = (e) => {
    ...
    return (
     ...
     {!showCart? (
        <div className=" {plantsArray.map((category, index) => (
       ...
       <div className="product-list">
           {category.plants.map((plant, plantIndex) => (
            ...
            <div className="product-card" key={plantIndex}>
               ...
               <button  className={cartItem && cartItem.quantity > 0 ? 'product-button added-to-cart' : 'product-button'} 
